...
\begin{document}
	...
	George Githinji$^{1,9}$, Ben Woodcroft$^{2,9}$, Joachim Baran$^{3,9}$, Francesco Strozzi$^{4,9}$, Raoul Bonnal$^{5,9}$, Naohisa Goto$^{6,9}$, Toshiaki Katayama$^{7,9}$, Hiroyuki Mishima$^{8,9}$, and Pjotr Prins$^{9,10}$\\ 				
